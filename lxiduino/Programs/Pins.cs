...
namespace Programs
{
    ...
    public static class Pins
    {
        ...
        private static bool DoHelp(TelnetServer Server, string Page)
        {
            switch (Page)
            {
                ...
                case "LISTPINS":
                    ...
                    return true;
                case "CONFIGPIN":
                    Server.Print("CONFIGPIN [PIN] [TYPE]                Configures a pin");
        ...
        //added by 7m4mon
        public static void PinInit()
        {
            int PinIndex;
            PinIndex = _PinToIndex("A0");
            _Pins[PinIndex].ConfigureAnalogIn();
            PinIndex = _PinToIndex("A1");
            _Pins[PinIndex].ConfigureAnalogIn();
            PinIndex = _PinToIndex("A2");
            _Pins[PinIndex].ConfigureAnalogIn();
            PinIndex = _PinToIndex("A3");
            _Pins[PinIndex].ConfigureAnalogIn();
            PinIndex = _PinToIndex("D5");
            _Pins[PinIndex].ConfigurePWM();
            PinIndex = _PinToIndex("D6");
            _Pins[PinIndex].ConfigurePWM();
            PinIndex = _PinToIndex("D9");
            _Pins[PinIndex].ConfigurePWM();
            PinIndex = _PinToIndex("D10");
            _Pins[PinIndex].ConfigurePWM();
