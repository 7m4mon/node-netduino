...
namespace Terminal_Server
{
    ...
    public class Program
    {
        ...
        //this flag pass to the authorities, suppress shell prompts and local echos,
        public static bool lxiMode = true;
        ...
        public static void Main()
        {
            ...
            //Programs.Pins.ConfigurePin(4, Pins.GPIO_PIN_A4, "A4");    Using for debug I2C
            //Programs.Pins.ConfigurePin(5, Pins.GPIO_PIN_A5, "A5");    Using for debug I2C
            ...
            //Programs.Pins.ConfigurePin(9, Pins.GPIO_PIN_D1, "D1");    Using for debug UART
            //Programs.Pins.ConfigurePin(10, Pins.GPIO_PIN_D2, "D2");   Using for debug UART
        ...
        static void Shell_OnDisconnected(Programs.ShellCore Shell, string RemoteAddress, DateTime Time)
        {
            ...
            Shell.Start();
            Debug.Print("Shell_OnDisconnected");
        }
